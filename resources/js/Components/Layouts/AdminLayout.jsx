    ...
    return (
        ...
        <div className="min-h-screen bg-muted/40 text-foreground flex">
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                {/* Dark, matching the sidebar — the two together frame the light
                    workspace, so the chrome reads as one piece rather than a
                    dark rail beside a white bar. */}
                <header className="dark bg-card border-b border-border sticky top-0 z-20">
