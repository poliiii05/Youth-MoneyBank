...
export default function About() {
    ...
    return (
        // Added scroll-smooth and a clean slate background
            ...
            <main className="flex-1 w-full">
                ...
                <div className="max-w-7xl mx-auto px-4 py-12 md:px-8 lg:py-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[280px]">
                        ...
                        {/* 2. WHO WE SERVE (Tall Card - Right) */}
                        ...
                        {/* 4. LIGHTNING FAST (Square - Bottom Middle) */}
                ...
                {/* ========================================== */}
                {/* HOW IT WORKS SECTION (Static, No Hover)    */}
                {/* ========================================== */}
