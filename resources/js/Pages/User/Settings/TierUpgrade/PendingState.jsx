...
export default function PendingState({ application }) {
    ...
    return (
        <div className="py-8 flex flex-col items-center text-center">
            {/* Icon */}
            <div className="w-20 h-20 bg-gradient-to-br from-amber-300 to-amber-500 rounded-full flex items-center justify-center shadow-lg shadow-amber-200 mb-4 animate-pulse">
            ...
            <div className="bg-amber-50/40 border border-amber-200 rounded-xl p-5 w-full max-w-md">
                <div className="space-y-3">
                    <div className="flex items-center justify-between">
                        ...
                        <p className="text-xs font-bold text-slate-900">{submittedDate}</p>
                    </div>
                    <div className="flex items-center justify-between">
                        <p className="text-[10px] font-bold text-amber-800 uppercase tracking-widest">Target Tier</p>
                        <p className="text-xs font-bold text-slate-900">Tier {application.target_tier}</p>
                    </div>
                    <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <p className="text-xs font-mono font-bold text-slate-700">#{application.id}</p>
                    </div>
                </div>
