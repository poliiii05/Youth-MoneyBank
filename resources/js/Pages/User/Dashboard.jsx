    ...
    return (
        <UserLayout user={user} header="Dashboard Overview">
            ...
            <div className="bg-white rounded-[1.5rem] shadow-sm border border-blue-50 p-5 mb-4 flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                <button className="px-5 py-2.5 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 shadow-md shadow-blue-200/50 cursor-pointer transition-all flex items-center gap-2 text-sm">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
                ...
                {/* MAIN WALLET (More compact height, softer text weights) */}
            ...
            {/* 4. QUICK ACTIONS (Interactive hover states & glows) */}
           ...
           {/* 5. RECENT TRANSACTIONS (Softer titles) */}
            <div className="bg-white rounded-[1.5rem] shadow-sm border border-gray-100 overflow-hidden">
                <div className="flex items-center justify-between p-5 border-b border-gray-50 bg-slate-50/30">
                    <h2 className="text-[11px] font-semibold text-gray-500 uppercase tracking-widest">Transactions</h2>     <Link href="/transactions" className="text-blue-600 font-semibold text-[11px] hover:underline cursor-pointer">View All</Link>
                            </div>
                ...
                <div className="p-10 flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-xs text-gray-400 mt-1 max-w-xs mx-auto leading-relaxed font-medium">
                        Add your first ₱100 to begin your financial journey.
                    </p>
                </div>
            </div>
